...
const SingleChoiceManagePage = () => {
  ...
  const handleEdit = (questionId: number) => {
    ...
    const url = `/facultyMember/questions/singleChoice/modify?questionId=${questionId}${contextParam}`;
    router.push(url);
  };
  ...
  const handleContextChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const newUrl = `/facultyMember/questions/singleChoice/manage${newContext === "global" ? "" : `?courseId=${newContext}`}`;
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <button
              ...
              onClick={() =>
                selectedContext &&
                router.push(
                  `/facultyMember/questions/singleChoice/create${selectedContext === "global" ? "" : `?courseId=${selectedContext}`}`,
                )
              }
            >
              Add New Question
        ...
        {isLoading || selectedContext === null ? (
          ...
          <div className="bg-primary p-8 rounded-lg shadow text-center">
            <p className="text-lg mb-4">
              No single choice questions found for this context.
            </p>
            <CustomButton
              label="Create Your First Question"
              url={`/facultyMember/questions/singleChoice/create${selectedContext === "global" ? "" : `?courseId=${selectedContext}`}`}
              width="w-auto"
            />
          </div>
        ) : (
                    ...
                    {(question.optionsSCMC || []).map((option, index) => (
                      <div
                        ...
                        className={`p-2 mb-2 rounded ${
                          index === question.correctOptionIndexSC
...
export default SingleChoiceManagePage;
