...
public class Course {
  ...
  /**
   * List of materials (resources) associated with this course. One-to-many relationship: one course
   * can have multiple materials.
   */
  ...
  /**
   * Adds a material to this course and establishes the bidirectional relationship.
   *
   * @param material The material to add to this course
   */
  ...
  /**
   * Removes a material from this course and breaks the bidirectional relationship.
   *
   * @param material The material to remove from this course
   */
